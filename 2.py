...
# p_3 = tf.nn.softmax(BN3)
# p_1 = tf.nn.sigmoid(tf.matmul(XX, w_1) + b_1)
# p_2 = tf.nn.sigmoid(tf.matmul(p_1, w_2) + b_2)
# p_3 = tf.matmul(p_2, w_3) + b_3
...
tr_step = tf.train.GradientDescentOptimizer(0.008).minimize(cross_entropy)
...
# print(sess.run(accuracy, feed_dict={XX: test, y_}))
